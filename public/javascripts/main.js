function init() {
    ...
    var descripcion = $("<div class ='row descripcion'><p>Bla blah</p></div>");
...
function loadChoice(numChoice) {
    ...
    $.getJSON("pantallas/choices.json", function (json) {
        ...
        if (choice.redir1.startsWith("c")) {
            $("#derecha").click(function (e) { e.preventDefault(); loadChoice(choice.redir1.substring(1, 2)); return false; });
        }
        else {
        ...
        if (choice.redir2.startsWith("c")) {
            $("#izquierda").click(function (e) { e.preventDefault(); loadChoice(choice.redir2.substring(1, 2)); return false; });
        }
        else {
            $("#izquierda").click(function (e) { e.preventDefault(); loadEnding(choice.redir2.substring(1, 2)); return false; });
        }
